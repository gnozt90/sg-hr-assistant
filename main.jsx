    ...
    <div className="space-y-6 animate-fadeIn">
      <div className="bg-gradient-to-r from-blue-700 to-indigo-800 p-8 rounded-2xl shadow-xl text-white">
        ...
        <div className="relative max-w-xl flex gap-2">
          ...
          />
          <button onClick={handleSearch} className="bg-orange-500 hover:bg-orange-600 text-white font-bold px-6 rounded-xl shadow-lg">Search</button>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {hasSearched ? (
          <div className="bg-white border border-slate-200 rounded-xl p-6 text-slate-600 text-sm">
            <p className="font-semibold text-slate-800 mb-3">Open results directly on job boards:</p>
            <div className="flex flex-wrap gap-2">
              {getJobBoardLinks().map((source) => (
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 text-slate-600 text-sm">
            <p className="font-semibold text-slate-800 mb-2">Search to open job boards.</p>
